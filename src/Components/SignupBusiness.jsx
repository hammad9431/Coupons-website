...
<div className="min-h-screen flex px-4 md:px-8 lg:px-20 rounded-2xl lg:mt-36 md:mt-16 mt-16">
  ...
  <div className="w-full lg:w-1/2 flex items-center justify-center bg-gray-100 px-6 py-12 my-8">
